import type { ServantDetail } from "@/lib/servant-detail"
...
// Servant page body, shared by NA (prerendered from files) and JP (loaded in the browser).
export function ServantPageView({ servant }: { servant: ServantDetail }) {
        ...
        <header className="space-y-3">
          <div>
            ...
            {servant.originalName ? (
              <p lang="ja" className="mt-1 text-sm text-muted-foreground">{servant.originalName}</p>
            ) : null}
          </div>
